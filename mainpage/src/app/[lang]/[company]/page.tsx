        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-block bg-sindicato-red/90 torn-edge px-6 py-2 mb-4">
              <span className="text-sindicato-warm-white font-bold uppercase tracking-wider text-sm font-button">
                Company Campaign
              </span>
            </div>
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-sindicato-warm-white mb-4 font-heading">
              {displayName}
            </h1>
            <EntityReachStats entityType="company" entityId={slug} />
          </motion.div>
            ...
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
                ...
                >
                  ...
                  <p className="text-sindicato-warm-white/60 text-sm uppercase tracking-wider mt-2">
                    Total Cases
                  </p>
                </motion.div>
              ...
              <div className="bg-sindicato-red/10 border border-sindicato-red/30 p-6 mb-12 torn-edge">
                <p className="text-sindicato-warm-white/70 text-sm">
                      ...
                      <Link href={`/cases/${c.id}`}>
                        <div className="bg-sindicato-cream/5 border border-sindicato-cream/10 p-6 hover:border-sindicato-red/50 transition-colors torn-edge h-full flex flex-col">
                          <div className="flex items-start justify-between mb-3">
                            <div>
                              <p className="text-sindicato-warm-white font-bold text-lg">
                                {c.displayName}
                              </p>
                          ...
                          <p className="text-sindicato-warm-white/60 text-sm flex-1">
                            {c.story}
                          </p>
              ...
              <div className="text-center">
                <Link
                  ...
                  className="bg-sindicato-red text-sindicato-warm-white px-10 py-4 font-bold uppercase tracking-wider hover:bg-sindicato-red/90 transition-colors torn-edge font-button text-lg inline-block"
                >
