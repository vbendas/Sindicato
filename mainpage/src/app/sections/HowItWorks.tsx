          ...
          {steps.map((step, index) => (
            <div key={step.number} className="flex-1 relative">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                >
                  <step.icon className="w-5 h-5 text-sindicato-warm-white" />
                </motion.div>
                ...
                <motion.span
                  ...
                  className="text-lg font-bold text-sindicato-warm-white uppercase tracking-wider font-[family-name:var(--font-barlow)] mb-3"
                >
                  {step.title}
                </motion.span>
                ...
                <motion.p
                  ...
                  className="text-sindicato-warm-white/60 text-sm leading-relaxed max-w-[260px] mx-auto"
                >
                  {step.description}
                </motion.p>
              </div>
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="w-11 h-11 rounded-full bg-sindicato-charcoal flex items-center justify-center shrink-0 shadow-md relative z-10">
                <step.icon className="w-4 h-4 text-sindicato-warm-white" />
              </div>
              <div className="pt-1.5">
                <span className="text-base font-bold text-sindicato-warm-white uppercase tracking-wider font-[family-name:var(--font-barlow)] block mb-1.5">
                  {step.title}
                </span>
                <p className="text-sindicato-warm-white/60 text-sm leading-relaxed">
                  {step.description}
                </p>
              </div>
            </motion.div>
