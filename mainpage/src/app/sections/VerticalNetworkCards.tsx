    ...
    return (
      <section className="bg-sindicato-bordeaux py-24 sm:py-28">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <p className="text-sindicato-cream/40">Loading networks...</p>
        </div>
      </section>
    );
  }
    ...
    <section className="bg-sindicato-bordeaux py-24 sm:py-28 lg:py-32">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.h2
          ...
          className="text-3xl sm:text-4xl lg:text-5xl font-bold text-sindicato-cream uppercase text-center mb-14 font-[family-name:var(--font-barlow)] tracking-wide"
        >
          The Network
        </motion.h2>
            ...
            ([key, config], index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <h3 className="text-xl sm:text-2xl font-bold text-sindicato-cream mb-2 uppercase tracking-wider font-[family-name:var(--font-barlow)]">
                      {config.title}
                    </h3>
                    <p className="text-sindicato-cream/65 text-sm sm:text-base mb-6">
                      {config.description}
                    </p>

                    <div className="grid grid-cols-3 gap-4 mb-6">
                      <div className="text-center">
                        <div className="text-2xl sm:text-3xl font-bold text-sindicato-cream font-[family-name:var(--font-barlow)]">
                          {stats?.totalCases ?? 0}
                        </div>
                        <div className="text-sindicato-cream/40 text-xs uppercase tracking-wider font-[family-name:var(--font-jetbrains)]">
                          Cases
                        </div>
                      </div>
                      <div className="text-center">
                    ...
                    <div className="text-center">
                      <span className="inline-block border border-white/30 text-sindicato-cream px-6 py-2.5 text-sm font-bold uppercase tracking-wider transition-all hover:bg-white/10 font-[family-name:var(--font-barlow)]">
