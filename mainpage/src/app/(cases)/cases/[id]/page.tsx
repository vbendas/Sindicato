  ...
  if (loading) {
    return (
      <>
        ...
        <Header scrolledBg="bg-sindicato-charcoal/70 backdrop-blur-md border-white/5" clerkBg="bg-sindicato-bordeaux text-sindicato-cream" />
    ...
    return (
      <>
        ...
        <div className="min-h-screen bg-sindicato-charcoal flex flex-col items-center justify-center gap-6">
          <h1 className="text-3xl font-bold text-sindicato-cream font-[family-name:var(--font-barlow)]">
            Case Not Found
          </h1>
          ...
          <Link
            href="/cases"
            className="bg-sindicato-charcoal border border-white/30 text-sindicato-cream px-8 py-3 font-bold uppercase tracking-wider hover:bg-sindicato-charcoal/80 transition-all font-[family-name:var(--font-barlow)]"
          >
            Back to Cases Wall
          </Link>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 sm:p-8">
                <div className="flex items-center justify-between mb-6 pb-4 border-b border-white/10">
                  <span className="text-sindicato-cream/30 text-[10px] font-bold uppercase tracking-widest font-[family-name:var(--font-jetbrains)]">
                ...
                <div className="flex items-start justify-between mb-6">
                  ...
                  {Number(caseData.amountOwed) > 0 && (
                    <div className="text-right shrink-0">
                      <p className="text-sindicato-cream font-bold text-3xl">
                ...
                <div className="flex items-center gap-3 mb-6">
                  <Link
                    ...
                    className="text-sindicato-cream/60 hover:text-sindicato-cream text-sm font-semibold uppercase tracking-wider transition-colors"
                  >
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    {caseData.storyTranslated && (
                      <button
                        ...
                        className="text-sindicato-cream/50 hover:text-sindicato-cream text-xs uppercase tracking-wider transition-colors"
                      >
                ...
                <div className="flex items-center justify-between mt-6 pt-4 border-t border-white/10">
                  ...
                  <p className="text-sindicato-cream/20 text-[10px] font-[family-name:var(--font-jetbrains)]">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-6 sm:p-8">
                <TimelineSection caseId={id} workerId={caseData.workerId} />
              </div>
            </div>
          </motion.div>
        </div>
